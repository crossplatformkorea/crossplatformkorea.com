...
**Copilot Instructions for Internationalization (i18n)**

**Objective**: Provide guidelines and best practices for implementing internationalization in the application using the i18next library.

**File Scope**:

- Applies to files matching the patterns: `**/*.ts`, `**/*.tsx`, `**/*.jsx`, `**/*.json`
