...
After the presentations, there will be a networking session where attendees can freely exchange information and ask questions.

📍 **Event Information**

- **Date:** Wednesday, November 13, 7:00 PM ~ 9:20 PM
- **Venue:** 2nd Floor, 35 World Cup Buk-ro, Mapo-gu, Seoul (Monimoni)

---

### **[Session 1]**

📍 **Topic:** Combining Async and UI: Implementing with Zustand<br />
**Speaker:** Myungjoo Moon (MJ Studio)

📍 **Agenda:**

- Asynchronous tasks and state management
- A frontend developer's mindset towards asynchronous states
- A brief introduction to Zustand
- The journey to developing an async state management library using Zustand
- Challenges in supporting TypeScript development

---

### **[Session 2]**

📍 **Topic:** Useless Experiments with React Native Skia<br />
**Speaker:** Jongbae Yoon (Neosapience)

📍 **Agenda:**

- What is Skia?
- Exploring Skia’s capabilities
- Skia as a drawing tool
- My experiments with Skia:
  - Shredder
  - Ink drop on canvas
- Conclusion
...
👇 **How to Register**<br />
[Meetup Link](https://www.meetup.com/ko-KR/crossplatformkorea/events/304324445)
...
After the presentation, there will be a networking session where participants can freely exchange information and ask questions.

📍 **Event Information**

- **Topic:** Sharing experiences on extracting type definition files using API Extractor and TypeScript Compiler API to fully support type definitions in the Sendbird SDK written in TypeScript.
- **Date:** Wednesday, August 28th, 7:00 PM - 8:20 PM, Networking from 8:30 PM onwards
- **Location:** V-Plex, 501 Teheran-ro, Gangnam-gu, Seoul
  - Note: Detailed venue information will be provided on the first floor on the day of the event.

📍 **Agenda**

- What is Type Definition?
- Compilation Tools: tsc, rollup plugins, API Extractor, tsup, ...
- Problem 1 - Supporting Multiple Entries
- Problem 2 - Hiding Private and Internal Interfaces
- Solving Issues Using TypeScript Compiler API
- Improving Library Usage Experience
- Enhancing Bundler Usage Experience

👇 **How to Register**
[Meetup Link](https://www.meetup.com/ko-KR/crossplatformkorea/events/302682322)

**Participation Fee Information**

- **Account:** KakaoBank Jang Hyochan 3333-19-6880688
  - Participation Fee
    - 15,000 KRW
    - Additional 20,000 KRW for after-party (Total 35,000 KRW)
  - Please include your meetup ID when making the deposit for smooth confirmation.
...
- **Topic:** Creating Libraries with the New Architecture in React Native
- **Date & Time:** Wednesday, June 26, 7:30 PM - 8:30 PM, Networking from 8:45 PM
- **Location:** VPLEX, 501 Teheran-ro, Gangnam-gu, Seoul
  - Note: Detailed venue information will be provided on the first floor on the day of the event.

📍 **Schedule**

- 0.74 and Bridgeless
- What to prepare for, how to choose libraries, interoperability between architectures
- Introduction to the Create React Native Library package
- Codegen and its operation
- Implementing Turbo Module
- Implementing Fabric
- How to support Old Architecture together

👇 **How to Register**
[Meetup Link](https://www.meetup.com/crossplatformkorea/events/301357125)

**Participation Fee Information**

- **Account:** Kakao Bank Jang Hyochan 3333-19-6880688
  - Participation Fee
    - 6,000 KRW
    - Additional 12,000 KRW for after-party (Total 18,000 KRW)
  - Please include your Meetup ID in the transfer for smooth verification.
...
<p style={{ fontWeight: "bold" }}>
  Insurance inquiry, comparison, claims, diagnosis, and analysis all in one
</p>
...
The meetup is scheduled for Wednesday, April 26th from 7:30 PM to 9:40 PM. The registration for the meetup will be opened soon. To stay updated on the registration and get notified quickly, please join the [Cross-Platform Korea Slack community](https://hyo.dev/joinCPK).
