...
In the [Router Section](./) as mentioned, while React Native has various routers like [react-navigation](https://reactnavigation.org) and [react-native-navigation](https://github.com/wix/react-native-navigation),
