    ...
    <div className="surface-card mb-6 p-5 sm:p-6">
      <div className="flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="relative group pt-2 pr-2 pb-2 pl-2">
          ...
          <div className="relative flex h-24 w-24 items-center justify-center overflow-hidden rounded-2xl bg-muted ring-4 ring-primary/10">
            {imagePreview ? (
        ...
        <div className="flex-grow grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
          {/* Display Name */}
          <div>
            <label className="field-label">{t('profile.fields.displayName.label')}</label>
            <input
              type="text"
              name="displayName"
          ...
          {/* 실명 (Real Name) */}
          <div>
            <label className="field-label">{t('profile.fields.realName.label')}</label>
            <input
              type="text"
              name="realName"
          ...
          <div className="md:col-span-2">
            <label className="field-label">{t('profile.fields.organization.label')}</label>
            <input
              type="text"
              name="organization"
