    ...
    <div className={cn('surface-card-interactive relative overflow-hidden', className)}>
      ...
      <div className="relative w-full overflow-hidden bg-muted">
        {showcase.imageUrl && !imageFailed ? (
          ...
          <div className="flex h-48 items-center justify-center bg-muted">
            <AppWindow size={48} className="text-muted-foreground" />
          </div>
        )}
        ...
        {showcase.featured && (
          <span
            className={cn(
              'absolute right-3 top-3 rounded-md bg-primary px-2 py-1 font-mono text-[10px] font-semibold uppercase tracking-[0.08em] text-primary-foreground dark:border dark:border-border/80 dark:bg-muted dark:text-foreground',
            )}
          >
            {t('showcase.featured')}
          </span>
      ...
      <div className="p-4">
        ...
        <div className="mb-2 flex items-center justify-between">
          <span
            className={cn(
              'rounded-md border border-border bg-muted/60 px-2 py-1 font-mono text-[10px] font-semibold uppercase tracking-[0.08em] text-muted-foreground',
            )}
          >
        ...
        {/* 설명 */}
        <p className="mb-3 text-sm leading-6 text-muted-foreground">{showcase.description}</p>
